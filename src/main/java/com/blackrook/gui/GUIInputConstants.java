 ...
 * Use of these is encouraged, as this unifies the input into the GUI system.
...
public interface GUIInputConstants
{
	...
	public static final int MOUSE_BUTTON4 = 4;
	...
	public static final int MOUSE_BUTTON5 = 5;
	...
	public static final boolean AXIS_TAP_POSITIVE = true;
	/** Gamepad axis tap: negative. */
	public static final boolean AXIS_TAP_NEGATIVE = false;
